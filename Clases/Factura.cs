    ...
    class Factura
    {
        public class CreaTicket
        {
            ...
            public static void EncabezadoVenta()
            {
                ...
                string LineEncabesado = "Prod      Cant   Precio    Total";   // agrega lineas de  encabezados
            ...
            public void AgregaTotales(string par1, double total)
            {
                ...
                {
                    cort = max - 32;
                    parte1 = par1.Remove(32, cort);          // si es mayor que 25 lo corta
                }
                else { parte1 = par1; }                      // **********
                ticket = parte1;
                parte2 = total.ToString();
                max = 31- (parte1.Length + parte2.Length);
                for (int i = 0; i < max; i++)                // **********
                {
